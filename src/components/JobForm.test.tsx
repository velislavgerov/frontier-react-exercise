...
test('JobForm produces expected output', async () => {
  ...
  const fullname = result.container.querySelector('[name=fullname]') as HTMLInputElement
  const email = result.container.querySelector('[name=email]') as HTMLInputElement
  const age = result.container.querySelector(`[name=age][value=${expectedData.age}]`) as HTMLInputElement
  ...
  const languages = result.container.querySelector('[name=languages]') as HTMLInputElement
  const workspace = result.container.querySelector(`[name=workspace][value=${expectedData.workspace}]`) as HTMLInputElement
  const experience = result.container.querySelector('[name=experience]') as HTMLInputElement
  const hours_on_project = result.container.querySelector('[name=hours_on_project]') as HTMLInputElement
